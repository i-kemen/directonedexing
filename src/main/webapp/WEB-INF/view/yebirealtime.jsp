        ...
        <div class="contents-top">
                    ...
                    <table border="1">
                        ...
                        <c:forEach var="item" items="${items}">
                            <tr data-ticker="${item.ticker}">
                                <td data-type="portfolioId">${item.portfolioId}</td>
                                <td data-type="itemId">${item.itemId}</td>
                                <td data-type="market">${item.market}</td>
                                <td data-type="ticker">${item.ticker}</td>
                                <td data-type="stockname">${item.stockname}</td>
                                <td>${item.weight}%</td>
                            </tr>
                        </c:forEach>
                        </tbody>
            ...
            <div class="index-right">
                ...
                <div id="tab-buy" class="tab-content active">
                    ...
                    <div class="tab-content-item">
                        <button onclick="preBuyStock()">구매</button>
                    </div>
                </div>
...
<script>
    ...
    function generateOrderData(type) {
        ...
        const market = document.getElementById("stock-market").innerText;
        const ticker = document.getElementById("stock-ticker").innerText;
        const stockname = document.getElementById("stock-name").innerText;
    ...
    function processOrder() {
        ...
        closeModal();  // 확인 모달 닫기
        openResultModal(window.orderFunction === buyStock);  // 결과 모달 열기
    }
</script>
