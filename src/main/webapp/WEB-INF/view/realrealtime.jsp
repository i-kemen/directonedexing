...
<script>
    ...
    function updateTableWithReceivedData(strResult) {
        ...
        let tableHTML =
            ...
            "<tr><td>매도호가10</td><td>" + strResult[12] + "</td><td>잔량10</td><td>" + strResult[32] + "</td></tr>" +
            "<tr><td>매도호가09</td><td>" + strResult[11] + "</td><td>잔량09</td><td>" + strResult[31] + "</td></tr>" +
            "<tr><td>매도호가08</td><td>" + strResult[10] + "</td><td>잔량08</td><td>" + strResult[30] + "</td></tr>" +
            "<tr><td>매도호가07</td><td>" + strResult[9] + "</td><td>잔량07</td><td>" + strResult[29] + "</td></tr>" +
            "<tr><td>매도호가06</td><td>" + strResult[8] + "</td><td>잔량06</td><td>" + strResult[28] + "</td></tr>" +
            "<tr><td>매도호가05</td><td>" + strResult[7] + "</td><td>잔량05</td><td>" + strResult[27] + "</td></tr>" +
            "<tr><td>매도호가04</td><td>" + strResult[6] + "</td><td>잔량04</td><td>" + strResult[26] + "</td></tr>" +
            "<tr><td>매도호가03</td><td>" + strResult[5] + "</td><td>잔량03</td><td>" + strResult[25] + "</td></tr>" +
            "<tr><td>매도호가02</td><td>" + strResult[4] + "</td><td>잔량02</td><td>" + strResult[24] + "</td></tr>" +
            "<tr><td>매도호가01</td><td>" + strResult[3] + "</td><td>잔량01</td><td>" + strResult[23] + "</td></tr>" +
            "<tr><td>매수호가01</td><td>" + strResult[13] + "</td><td>잔량01</td><td>" + strResult[33] + "</td></tr>" +
            "<tr><td>매수호가02</td><td>" + strResult[14] + "</td><td>잔량02</td><td>" + strResult[34] + "</td></tr>" +
            "<tr><td>매수호가03</td><td>" + strResult[15] + "</td><td>잔량03</td><td>" + strResult[35] + "</td></tr>" +
            "<tr><td>매수호가04</td><td>" + strResult[16] + "</td><td>잔량04</td><td>" + strResult[36] + "</td></tr>" +
            "<tr><td>매수호가05</td><td>" + strResult[17] + "</td><td>잔량05</td><td>" + strResult[37] + "</td></tr>" +
            "<tr><td>매수호가06</td><td>" + strResult[18] + "</td><td>잔량06</td><td>" + strResult[38] + "</td></tr>" +
            "<tr><td>매수호가07</td><td>" + strResult[19] + "</td><td>잔량07</td><td>" + strResult[39] + "</td></tr>" +
            "<tr><td>매수호가08</td><td>" + strResult[20] + "</td><td>잔량08</td><td>" + strResult[40] + "</td></tr>" +
            "<tr><td>매수호가09</td><td>" + strResult[21] + "</td><td>잔량09</td><td>" + strResult[41] + "</td></tr>" +
            "<tr><td>매수호가10</td><td>" + strResult[22] + "</td><td>잔량10</td><td>" + strResult[42] + "</td></tr>" +
