...
<script>
    ...
    // 데이터를 받아올 때마다 테이블을 업데이트하는 함수
    function updateTableWithReceivedData(data) {
        const tableHTML = parseDataToTable(data);

        // 예: outputTableArea라는 id를 가진 element에 테이블 HTML을 삽입
        document.getElementById("outputTableArea").innerHTML = tableHTML;
    }
</script>
